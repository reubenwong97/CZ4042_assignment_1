...
X_train_4 = np.delete(X_train_5, [1], axis=1)
...
compare_subset_lengths(mse_array, 7, 'comparing_subset_567_new0111', 'perfomance of models trained on subset of features', path='./figures/2a_2/')
